...
const PRODUCT_DATA = {
  ...
  description: 'SSD de 500 Gb marca KINGSTON, con programas ISO como Windows 25H2, OFFICE 365 y WPI 2024, WhatsApp 75952323',
  images: [
...
export default function ProductDetailsScreen() {
  const [activeTab, setActiveTab] = useState<'description' | 'seller' | 'details'>('description');
          ...
          <View className="flex-row border-b border-gray-200">
            <Pressable
              ...
              className={`flex-1 pb-3 ${
                activeTab === 'description' ? 'border-b-2 border-gray-900' : ''
              }`}
            >
              <Text
            ...
            <Pressable
              ...
              className={`flex-1 pb-3 ${
                activeTab === 'seller' ? 'border-b-2 border-gray-900' : ''
              }`}
            >
              <Text
                className={`text-center font-semibold ${
                  activeTab === 'seller' ? 'text-gray-900' : 'text-gray-500'
                }`}
              >
                Seller information
              </Text>
            ...
            >
              <Text
                className={`text-center font-semibold ${
                  activeTab === 'details' ? 'text-gray-900' : 'text-gray-500'
                }`}
              >
                Details
              </Text>
      ...
      <View className="absolute bottom-0 left-0 right-0 bg-white border-t border-gray-200 px-4 py-4">
        <Button
          ...
          onPress={() => {
            ...
            console.log('Realizar pago pressed');
          }}
        >
          Realizar pago
        </Button>
